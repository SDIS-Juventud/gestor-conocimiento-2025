...
{quick_links}                </div>
            ...
            <div class="content-section" id="cambios2026"><div class="card">
                ...
                <p style="line-height:1.7;">Se implementó un nuevo paso llamado “enrutamiento”. Cuando un joven llega a la Casa de Juventud, se le aplica un cuestionario inicial para identificar sus intereses y necesidades puntuales. A partir de allí, se le orienta hacia la oferta institucional adecuada.</p>

                <h3 class="card-subtitle">Mínimos operativos y regulación de alianzas</h3>
                <p style="line-height:1.7;">El nivel central define “mínimos operativos” mensuales por cada eje que todas las localidades deben cumplir. Estos mínimos se ajustan a momentos específicos del año (por ejemplo, actividades conmemorativas del 8M o inducción a nuevos consejeros). También se estructuró la figura del voluntariado: quienes deseen impartir talleres deben llenar un formulario, presentar documentos de seguridad y someter su metodología a revisión técnica.</p>
