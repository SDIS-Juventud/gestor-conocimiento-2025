...
CSS = """        @import url('https://fonts.googleapis.com/css2?family=Figtree:wght@400;500;600;700;800&display=swap');
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-title .arrow { display: inline-block; width: 8px; height: 8px; border-top: 2px solid #663A93; border-right: 2px solid #663A93; transform: rotate(45deg); font-size: 0; color: transparent; transition: transform 0.25s ease; margin-right: 4px; }
        ...
        .sidebar-item:hover { background: #f5f0fa; }
        .sidebar-item.active { background: #ede7f6; color: #663A93; font-weight: 600; }
        ...
        .tree-label { font-weight: 600; color: #6C6294; }
...
{quick_links}                </div>
            ...
            <div class="content-section" id="homologacion"><div class="card">
                <h2 class="card-title">Tabla de homologación por eje
                    <span class="sirbe-help" onclick="document.getElementById('sirbe-tooltip').style.display=document.getElementById('sirbe-tooltip').style.display==='block'?'none':'block'" style="display:inline-flex; align-items:center; justify-content:center; width:22px; height:22px; border-radius:50%; background:#663A93; color:#fff; font-size:0.7rem; font-weight:700; cursor:pointer; margin-left:8px; vertical-align:middle; position:relative;">?</span>
                </h2>
...
<h3 class="card-subtitle">Estructura oficial en SIRBE</h3>
                ...
                <div style="margin-bottom:20px;">
                    <a href="https://servicios.sdis.gov.co/index.php/casas-juventud" target="_blank" style="display:inline-block; padding:10px 20px; background:#663A93; color:#fff; border-radius:8px; text-decoration:none; font-size:0.9rem; font-weight:600;">Link oficial para agendamiento de citas en Casas de Juventud</a>
                </div>
