...
SECCION_EQUIPO = """\
            <div class="content-section" id="equipo">
                <div class="card">
                    ...
                    <p style="line-height:1.7;">Aproximadamente <strong>122 profesionales</strong> distribuidos en los siguientes componentes:</p>
                    ...
                    <table style="width:100%; border-collapse:collapse; font-size:0.85rem;">
                        ...
                        <tbody>
                            <tr style="background:#fff;">
                                <td style="padding:8px 10px; border-bottom:1px solid #eee;"><strong>Psicosocial</strong></td>
                                <td style="padding:8px 10px; border-bottom:1px solid #eee;">79</td>
                            ...
                            <tr style="background:#f8f9fa;">
                                ...
                                <td style="padding:8px 10px; border-bottom:1px solid #eee;">12</td>
                            ...
                            <tr style="background:#fff;">
                                ...
                                <td style="padding:8px 10px; border-bottom:1px solid #eee;">Resto</td>
