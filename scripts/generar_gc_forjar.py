...
# =====================================================================
# CSS base (compartido con otros gestores) + override de color Forjar
# =====================================================================
CSS_BASE = """\
@import url('https://fonts.googleapis.com/css2?family=Figtree:wght@400;500;600;700;800&display=swap');
* { margin: 0; padding: 0; box-sizing: border-box; }
:root { --accent: #663A93; --accent-bg: #f5f0fa; --accent-border: #ede7f6; }
...
# Override de color específico para Forjar (verde azulado)
CSS_FORJAR = """
    :root { --accent: #5f9ea0; --accent-bg: #edf6f6; --accent-border: #d4eaeb; }"""
...
SECCION_MODALIDADES = """\
            <div class="content-section" id="modalidades">
                <div class="card">
                    ...
                    <div style="display:flex; align-items:stretch; margin-bottom:10px; border-radius:8px;">
                        <div style="background:#5f9ea0; color:#fff; min-width:160px; padding:14px 20px 14px 16px; display:flex; align-items:center; font-weight:700; font-size:0.88rem; position:relative; clip-path:polygon(0 0, calc(100% - 20px) 0, 100% 50%, calc(100% - 20px) 100%, 0 100%); z-index:2; position:relative;">Internaci&oacute;n en medio semicerrado</div>
                        <div style="background:#2F3E3C; color:#F8F4E1; flex:1; padding:14px 18px 14px 28px; font-size:0.85rem; line-height:1.6; margin-left:-20px; border-radius:0 8px 8px 0;">Vinculaci&oacute;n a un programa de atenci&oacute;n especializada que se cumple durante el horario no escolar o no laboral.</div>
                    </div>
